        ...
        <table id="grid" class="w3-table w3-striped w3-bordered w3-responsive" style="color: #555;">
          <thead class="w3-theme">
            <tr>
              ...
              <th width="10%" class="w3-center">Asignar</th>
            </tr>
          </thead>
          <tbody>
            <?php
            $conn = new mysqli(DBHOST, DBUSER, DBPWD, DBNAME);
            $sql = "SELECT * FROM tiquets INNER JOIN clientes ON id_cliente = cliente_id INNER JOIN estados on id_estado = estado_id INNER JOIN servicios on id_servicio = servicio_id";
            ...
            ?>
                <tr>
                  ...
                  <td class="w3-center cat"><?php echo $row["servicio"] ?></td>
