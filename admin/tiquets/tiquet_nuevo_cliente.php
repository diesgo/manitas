...
<form accept-charset="utf-8" action="create_check.php" method="POST" name="nuevoCliente" id="nuevoCliente" class="w3-content w3-theme-l4 w3-round w3-padding w3-card">
  <div class="section">
    ...
    <div class="w3-row w3-border w3-border-theme w3-padding">
      <div class="w3-col w3-padding">
        <legend for="actuacion" class="w3-text-theme-dark w3-medium">Actuación</legend>
