      ...
      <div class="w3-container w3-responsive">
        <form accept-charset="utf-8" action="profile_check.php" method="POST" name="user_profile" id="user_profile">
          ...
          <div class="w3-row">
            ...
            <div class="w3-col m3 l2 s4">
              <div>
                <img class="w3-image" src="../../img/admin/<?php echo $_SESSION['username'] ?>.png" alt="<?php echo $_SESSION['username'] ?>">
              </div>
              <div class="w3-container w3-center">
                <h3 class="w3-text-theme">contraseña</h3>
                <a class="w3-btn w3-theme w3-round" href="update.php?id_user=<?php echo $user['id_user'] ?>">Cambiar contraseña</a>
              </div>
            </div>
            ...
            <div class="w3-col m8 l9 s8">
              ...
              <div class="w3-row w3-padding">
                <div class="w3-col l6 m6">
                  <?php
                  if ($user['grupo_id'] == 1) {
                  include '../templates/cambio_rol.php';
                  } else {
                    include '../templates/cambio_rol_blank.php';
                  }
                  ?>
                </div>
                <div class="w3-col l6 m6">
          ...
          <div class="w3-row w3-padding-24 w3-center">
            ...
            <div class="w3-col l6 m6 s6 w3-left-align w3-padding-large">
              <input type="submit" value="Update" name="update" class="w3-btn w3-theme w3-round w3-hover-theme-light">
            </div>
