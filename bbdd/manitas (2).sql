...
-- Tiempo de generación: 20-04-2023 a las 11:14:39
...
INSERT INTO `servicios` (`id_servicio`, `servicio`, `descripcion_servicio`, `date_add`, `date_upd`) VALUES
(1, 'Electricidad', 'Instalaciones Elecetricas.\r\nSustitucuón de mecanismos.\r\nActualización de cuadros.', '2022-03-16 16:05:04', '2023-04-05 16:27:55'),
(2, 'Albañileria', 'Construcción y reformas en general.', '2022-03-19 07:19:40', '2023-04-05 16:28:50'),
(3, 'Fontanería', 'Fugas de agua.\r\nSustitucuón de grifos.\r\nArreglos de WC', '2022-04-06 17:33:25', '2023-04-05 16:29:45'),
(4, 'Calefacción', 'Mantenimiento de sistemas de calefacción (purgar circuito y revisión de válvulas)\r\nInstalación y reparación de sistemas de calefacción.', '2022-04-28 21:38:24', '2023-04-05 16:31:41'),
(5, 'Carpintería', 'Arreglo de armarios.\r\nCocinas.\r\nMontaje de muebles.\r\nPuertas.', '2022-07-17 20:59:43', '2023-04-05 16:33:39'),
(6, 'Sin determinar', '', '2023-04-20 10:50:23', '2023-04-20 10:50:23');
...
CREATE TABLE IF NOT EXISTS `tiquets` (
  `id_tiquet` int NOT NULL AUTO_INCREMENT,
  `cliente_id` int NOT NULL,
  `servicio_id` int DEFAULT '1',
  `actuacion` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
...
(5, 2, 1, 'Purgar radiadores', 1, NULL, '2023-04-20 09:33:32');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tiquet_0`
--

DROP TABLE IF EXISTS `tiquet_0`;
CREATE TABLE IF NOT EXISTS `tiquet_0` (
...
--
-- Volcado de datos para la tabla `tiquet_0`
--

INSERT INTO `tiquet_0` (`fecha`, `estado_id`, `colaborador_id`, `comentario`) VALUES
('2023-04-20 09:33:32', 1, NULL, 'Apertura de tiquet');
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `tema_id` int DEFAULT '50',
  `fuente_id` int NOT NULL DEFAULT '21',
  `titulo_id` int NOT NULL DEFAULT '7',
  `date_add` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `date_upd` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id_user`),
